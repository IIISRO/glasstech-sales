        ...
        if (data){
            for (let revision of data['revisions']){
                if(revision['is_active'] === true){
                    ...
                    $('#offer_creator').val(revision.offer_creator.id);
                    $('#offer_approver').val(revision.offer_approver.id);
...
editOfferForm.addEventListener("submit", (e) => {
  ...
  for(let package of $('.packages')){
    ...
    let newerPackage = {}
    if(package.dataset.id){
      newerPackage['id'] = parseInt(package.dataset.id)
    }else{
      newerPackage['id'] = null
    }
    ...
    for(let service of package.getElementsByClassName('services')){
      ...
      let newerService = {}
      if(service.dataset.id){
        newerService['id'] = parseInt(service.dataset.id)
      }else{
        newerService['id'] = null
      }
