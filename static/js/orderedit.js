...
var ordeEditForm = document.getElementById('ordeEditForm')
ordeEditForm.addEventListener("submit", (e) => {
  e.preventDefault();
//   loader.show()
    ...
    var newOrder = {
        ...
        'transportation_note': $('#transport_note').val(),
        'installation_note': $('#installation_note').val(),
        'note': $('#note').val(),
        'prepayment': $('#pre_pay').val(),
        'nps': $('#nps').val(),
        ...
        'order_installer': parseInt($('#order_install').val()),
        }
