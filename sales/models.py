...
class Order(AbstractModel):
    ...
    plan_note =  models.CharField(max_length=255, blank=True, null=True)
    equipment_note = models.CharField(max_length=255, blank=True, null=True)
    production_note  = models.CharField(max_length=255, blank=True, null=True)
    packaging_note = models.CharField(max_length=255, blank=True, null=True)
    transportation_note = models.CharField(max_length=255, blank=True, null=True)
    installation_note = models.CharField(max_length=255, blank=True, null=True)
    note = models.CharField(max_length=255, blank=True, null=True)
    prepayment = models.CharField(max_length=255, blank=False, null=False)
